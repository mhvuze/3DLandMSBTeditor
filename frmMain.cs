...
namespace MsbtEditor
{
	public partial class frmMain : Form
	{
		...
		private void txtEdit_KeyUp(object sender, KeyEventArgs e)
		{
			...
			Entry entry = (Entry)lstStrings.SelectedItem;
			_msbt.TXT2.Entries[entry.Index].Values[lstSubStrings.SelectedIndex].Data = Encoding.UTF8.GetBytes(result.Replace("\r\n", "\n")); // Unicode
		...
		private void UpdateTextView()
		{
			...
			txtEdit.Text = Encoding.UTF8.GetString(_msbt.TXT2.Entries[entry.Index].Values[lstSubStrings.SelectedIndex].Data).Replace("\n", "\r\n"); // Unicode
		...
		private void UpdateOriginalText()
		{
			...
			txtOriginal.Text = Encoding.UTF8.GetString(_msbt.TXT2.OriginalEntries[entry.Index].Values[lstSubStrings.SelectedIndex].Data).Replace("\n", "\r\n"); // Unicode
        }
